...
class AuthorControllerTest {
    ...
    public void givenAuthorToUpdateThenShouldReturnUpdatedAuthor() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/1/author")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(author)))
                .andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
    ...
    @Test
    public void givenGetBookByAuthor() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(authorController).build();
        ...
        when(authorService.getBooksByAuthor(author.getAuthor_id())).thenReturn(bookList);
    ...
    @Test
    public void testFindAuthorCount() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(authorController).build();
        authorRequest=new AuthorRequest();
        authorRequest.setAuthor_id(1);
        authorRequest.setName("swathy");
        ...
        authorList2 = new ArrayList<>();
        authorList2.add(authorRequest);
        when(authorService.findAuthorCount()).thenReturn(1);
        mockMvc.perform(put("/api/v1/count/authors")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(author)))
                .andDo(MockMvcResultHandlers.print());
    }
